...
async def move_velocity(
    ...
    *,
    ...
    try:
        return await ctx.invoke("set_velocity", args, timeout_s=20)
    except Exception as e:
...
async def _advance_or_detour(
    ...
    *,
    ...
    if memory is not None:
        ...
        if win_side is not None and win_side != side:
            if verbose:
...
async def execute_decision(
    ...
    if action == "place_cube":
        ...
        return {"action": "place_cube", "result": result_summary(result), "positioned": True}
